	...
	IEnumerator RevealWords(TMP_Text textComponent)
	{
		...
		while (true)
		{
			...
			if (currentWord == 0) // Display no words.
				...
				visibleCount = textComponent.textInfo.wordInfo[currentWord - 1].lastCharacterIndex +
							   1;
			else if
				(currentWord == totalWordCount) // Display last word and all remaining characters.
